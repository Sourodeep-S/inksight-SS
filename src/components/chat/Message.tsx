...
// We enclose it in a forwardRef so that we can pass a ref as a prop, which normally can't be done in React.
      ...
      <div ref={ref} className={cn('flex items-end', {'justify-end': message.isUserMessage})}>
          ...
          <div className={cn("relative flex h-6 w-6 aspect-square items-center justify-center", {
              ...
              {message.isUserMessage ? (
                  ...
                  <Icons.quillLogo className='fill-zinc-300 h-3/4 w-3/4' />
              )}
          </div>
